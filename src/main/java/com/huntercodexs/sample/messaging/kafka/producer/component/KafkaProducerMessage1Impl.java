...
public class KafkaProducerMessage1Impl implements KakfaProducerIntegrationProcess {

    private static final Logger log = LoggerFactory.getLogger(KafkaProducerMessage1Impl.class);
    ...
    public boolean supports(String producerName) {
        return producerName.equals("SampleProducer1");
    }
    ...
    public HashMap<String, String> producerRecord(Object message) {
        ...
        hashMap.put("header-key", "SampleHeaderValue1");
