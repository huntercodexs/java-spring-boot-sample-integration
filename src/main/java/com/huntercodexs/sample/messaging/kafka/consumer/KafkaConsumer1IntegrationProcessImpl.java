...
@Component
public class KafkaConsumer1IntegrationProcessImpl implements KafkaConsumerIntegrationProcess {

    private static final Logger log = LoggerFactory.getLogger(KafkaConsumer1IntegrationProcessImpl.class);
    ...
    public boolean supports(Headers headers, Object value, Object key, int partition, long offset) {
        ...
        return "SampleHeaderValue1".equals(value2);
    }
