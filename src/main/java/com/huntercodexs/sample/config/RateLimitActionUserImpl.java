...
@Component
public class RateLimitActionUserImpl implements RateLimitServiceBusAction {

    private static final Logger log = LoggerFactory.getLogger(RateLimitActionUserImpl.class);
